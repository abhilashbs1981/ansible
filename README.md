...
|--------|-----------|-------------|
| **Updated** | `environments/envs/ems503/ems503.inventory` | Modified inventory structure |
| **Added** | `environments/envs/ems503/host_vars/ems503-secondary/vars` | Secondary EMS variables |
| **Added** | `environments/envs/ems503/host_vars/ems503-secondary/vault` | Secondary EMS vault file |
...
| Target | Host | Variable Loading Order |
|--------|------|----------------------|
| **Primary** | `ems503` | `host_vars/ems503/*` + `group_vars/access40/*` + inventory line vars |
| **Secondary** | `ems503-secondary` | `host_vars/ems503-secondary/*` + `group_vars/access40/*` + inventory line vars |
...
|--------|-------------------|-----------------|
| **Target Groups** | Single EMS group | `ems,ems_secondary` groups |
| **Host Targeting** | Fixed targeting | Flexible with `-l` flag |
| **Kubeconfig Generation** | Single config file | Separate config per EMS instance |
...
|---------|--------|-------------|
| `-l ems` | Primary EMS hosts only | Targets only primary EMS hosts |
| `-l ems_secondary` | Secondary EMS hosts only | Targets only secondary EMS hosts |
| `-l ems,ems_secondary` | Both EMS groups | Targets both primary and secondary EMS hosts |
...
|---------|--------|--------|
| **Default** | Both EMS instances | Purges both primary and secondary |
| **Primary Only** | Primary EMS | Purges only primary EMS |
| **Secondary Only** | Secondary EMS | Purges only secondary EMS |
| **Both Explicit** | Both EMS instances | Purges both EMS instances |
...
|---------|-------------|----------|
| `-l ems` | Target primary EMS only | Primary EMS operations |
| `-l ems_secondary` | Target secondary EMS only | Secondary EMS operations |
| `-l ems,ems_secondary` | Target both EMS instances | Full deployment/purge |

### Appendix C: Change Log

| Version | Date | Author | Changes |
|---------|------|--------|---------|
| 1.0 | [Date] | [Author] | Initial implementation of secondary EMS support |
